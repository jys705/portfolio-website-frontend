  ...
  return (
    ...
    items-center justify-center gap-4'>
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
                Hello! I'm YeonSeung Jeong <Image src={assets.hand_icon} alt=''
            className='w-6'/></motion.h3>
    <motion.h1 
    initial={{y: -30, opacity: 0}} 
    whileInView={{y: 0, opacity: 1}}
    transition={{duration: 0.8, delay: 0.5}}
    className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo px-2 max-w-[100vw] break-words'>
        ...
        className='max-w-2xl mx-auto font-Ovo px-2'>
